...
// public class TwoCycleAuto extends SequentialCommandGroup {
//   /**
//    * Creates a new OneCycleAuto.
//    */
//   public TwoCycleAuto(SwerveDriveSubsystem swerveDriveSubsystem, ConveyorTalon conveyorTalon, Intake intake, Shooter shooter, int inputRPM, double delayInSeconds) {
