...
// public class OneCycleAutoStop extends SequentialCommandGroup {
//   /**
//    * Creates a new OneCycleAuto.
//    */
//   public OneCycleAutoStop(SwerveDriveSubsystem swerveDriveSubsystem, ConveyorTalon conveyorTalon, Intake intake, Shooter shooter, int inputRPM, double delayInSeconds) {
